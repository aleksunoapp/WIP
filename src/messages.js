...
const frCA = {
  ...
  new_services: 'Services approuvés',
  total_cost: 'Total à la livraison',
  total_updated_cost: 'Total à la livraison',
...
const esMX = {
  ...
  new_services: 'Servicios aprobados recientemente',
  total_cost: 'Total al momento de la entrega',
  total_updated_cost: 'Total al momento de la entrega',
