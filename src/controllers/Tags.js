...
export default {
  ...
  /**
   * Call to API to apply a tag to menu items.
   * @function
   * @param {integer} tagId - The id of the tag to apply.
   * @param {array} itemSkus - Array of SKUs to apply the tag to.
   * @returns {object} A promise that will return either a success object or an error object.
   */
  applyTagToMenuItems ({ tagId, itemSkus }) {
    return new Promise(function (resolve, reject) {
      GlobalFunctions.$ajax({
        method: 'POST',
        dataType: 'json',
        url: '/app/tags/addTagToItems',
        data: {
          tag_id: tagId,
          item_sku: itemSkus
        },
   ...
   * @returns {object} A promise that will return either a success object or an error object.
   */
  applyTagToModifierItems ({ tagId, itemSkus }) {
    return new Promise(function (resolve, reject) {
      GlobalFunctions.$ajax({
        method: 'POST',
        dataType: 'json',
        url: '/app/tags/addTagToModifierItems',
        data: {
          tag_id: tagId,
          modifier_item_sku: itemSkus
        },
        success: function (response) {
          resolve(response)
        },
