    ...
    >
      <div class="portlet-title bg-blue-chambray">
        ...
        <div class="caption">
          ...
          <div class="caption-desc font-grey-cascade">
            Create, edit or delete platforms.
          </div>
        </div>
      </div>
      <div class="col-md-12">
      ...
      <div class="portlet-body relative-block">
            ...
            <ul>
              ...
              >
                <div class="list-item-actions">
                  <el-tooltip
                    v-if="$root.permissions['localization platforms update']"
                    content="Edit"
                    effect="light"
                    placement="right"
                  >
                  ...
                  <el-tooltip
                    v-if="$root.permissions['localization platforms read'] && !$root.permissions['localization platforms update']"
                    content="View"
                    effect="light"
                    placement="right"
                  >
                  ...
                  <el-tooltip
                    v-if="$root.permissions['localization platforms delete']"
                    content="Delete"
                    effect="light"
                    placement="right"
                  >
        ...
        <div class="margin-top-20">
          <no-results
            :show="!platforms.length && !loadingPlatforms"
            :type="'platforms'"
          />
        </div>
      </div>
            ...
            <div class="col-md-12">
              <div class="form-group form-md-line-input form-md-floating-label">
                <input
                  ...
                  :disabled="!$root.permissions['localization platforms update']"
                  type="text"
                  class="form-control input-sm"
