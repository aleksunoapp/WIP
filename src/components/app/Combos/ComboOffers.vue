        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-md-6">
            ...
            <div class="form-group form-md-line-input form-md-floating-label">
              ...
              >
              <label for="form_control_discount">
                Discount value
              </label>
            </div>
            <div class="form-group form-md-line-input form-md-floating-label">
              ...
              >
              <label for="form_control_number_of_items">
                Number of Items
              </label>
            </div>
            <div class="margin-top-20">
              From:
              <el-date-picker
                v-model="newComboOffer.start_from"
                type="date"
                format="yyyy-MM-dd"
            ...
            <div class="margin-top-20">
              To:
              <el-date-picker
                v-model="newComboOffer.end_on"
                type="date"
                format="yyyy-MM-dd"
                value-format="yyyy-MM-dd"
                :clearable="false"
                :picker-options="newEndOptions"
      ...
      <div class="portlet-title bg-blue-chambray">
        ...
        <div class="caption">
          ...
          <div class="caption-desc font-grey-cascade">
            Create, edit or delete combo offers.
          </div>
        </div>
      </div>
      <div class="col-md-12">
            ...
            <ul>
              ...
              >
                <div class="list-item-actions">
                  <el-tooltip
                    v-if="$root.permissions['combo_offer update']"
                    content="Edit"
                    effect="light"
                    placement="right"
                  >
                  ...
                  <el-tooltip
                    v-if="$root.permissions['combo_offer read'] && !$root.permissions['combo_offer update']"
                    content="View"
                    effect="light"
                    placement="right"
                  >
                  ...
                  <el-tooltip
                    v-if="$root.permissions['combo_offer delete']"
                    content="Delete"
                    effect="light"
                    placement="right"
                  >
        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            <div class="form-group form-md-line-input form-md-floating-label">
              ...
              >
              <label for="form_control_start_from">
                From
              </label>
            </div>
            <div class="margin-top-20">
              ...
              <el-date-picker
                ...
                value-format="yyyy-MM-dd"
                :clearable="false"
                :picker-options="editedStartOptions"
                placeholder="Select start date"
              />
            </div>
            <div class="margin-top-20">
              To:
              <el-date-picker
                v-model="comboOfferToEdit.end_on"
                type="date"
                format="yyyy-MM-dd"
                value-format="yyyy-MM-dd"
                :clearable="false"
                :picker-options="editedEndOptions"
                placeholder="Select end date"
              />
            </div>
          </div>
