                ...
                <div class="col-md-6">
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Store Has Online Ordering</td>
                        <td>
                          <el-switch
                      ...
                      <tr>
                        <td>Store Has Online Ordering Enabled</td>
                        <td>
                          <el-switch
                      ...
                      <tr>
                        <td>Store Has Delivery Enabled</td>
                        <td>
                          <el-switch
                      ...
                      <tr>
                        <td>External online ordering enabled</td>
                        <td>
                          <el-switch
                      ...
                      <tr>
                        <td>Payment Processor Merchant ID (MID)</td>
                        <td>
                          <input
                      ...
                      <tr>
                        <td>Payment Processor Merchant Key</td>
                        <td>
                          <input
