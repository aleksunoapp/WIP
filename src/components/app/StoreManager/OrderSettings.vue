          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group form-md-line-input form-md-floating-label">
                ...
                >
                <label for="create_pickup_order_time_cut_off">
                  Pickup Order Time Cut Off
                </label>
              </div>
              <div class="form-group form-md-line-input form-md-floating-label">
                <input
                ...
                >
                <label for="form_control_3">
                  Pickup Cancellation Time Cut Off
                </label>
              </div>
              <div class="form-group form-md-line-input form-md-floating-label">
              ...
              <div class="form-group form-md-line-input form-md-floating-label">
                ...
                >
                <label for="form_control_3">
                  Group Order Cancellation Time Cut Off
                </label>
              </div>
              <div class="form-group form-md-line-input form-md-floating-label">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group form-md-line-input form-md-floating-label">
                ...
                >
                <label for="create_delivery_orders_per_slot">
                  Delivery Orders Per Slot
                </label>
              </div>
              <div class="form-group form-md-line-input form-md-floating-label">
                <input
              ...
              <div class="form-group form-md-line-input form-md-floating-label">
                ...
                >
                <label for="form_control_3">
                  Delivery Cancellation Time Cut Off
                </label>
              </div>
              <div class="form-group form-md-line-input form-md-floating-label">
              ...
              <div class="form-group form-md-line-input form-md-floating-label">
                ...
                >
                <label for="form_control_3">
                  Catering Cancellation Time Cut Off
                </label>
              </div>
              <div class="form-group form-md-line-input form-md-floating-label">
        ...
        <div class="portlet-title bg-blue-chambray">
          ...
          <div class="caption">
            ...
            <div class="caption-desc font-grey-cascade">
              Create, edit or delete Order Settings for the active store.
            </div>
          </div>
        </div>
        <div class="col-md-12">
