	...
	<div>
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<label v-if="!loadingItemTypes"
								...
								Pair with:
								<el-select v-if="!loadingItemTypes"
							...
							<label>
								Apply:
								<el-select v-model="newTaxClass.apply"
		...
		<div v-else>
			<div class="portlet light portlet-fit bordered margin-top-20"
				...
				<div class="portlet-body relative-block">
					<loading-screen :show="loadingTaxClasses"
					                :color="'#2C3E50'"
							...
							<ul>
								<li class="mt-list-item actions-at-left margin-top-15"
									...
									<div class="list-item-actions">
										<el-tooltip v-if="$root.permissions['tax tax_classes update']"
										            content="Edit"
										            effect="light"
										            placement="right">
										...
										<el-tooltip v-if="$root.permissions['tax tax_classes read'] && !$root.permissions['tax tax_classes update']"
										            content="View"
										            effect="light"
										            placement="right">
											<a class="btn btn-circle btn-icon-only btn-default"
										...
										<el-tooltip v-if="$root.permissions['tax tax_classes delete']"
										            content="Delete"
										            effect="light"
										            placement="right">
											<a class="btn btn-circle btn-icon-only btn-default"
					...
					<div class="margin-top-20">
						<no-results :show="!taxClasses.length && !loadingTaxClasses"
						            :type="'tax classes'"></no-results>
					</div>
				</div>
			</div>
		</div>
		...
		<modal :show="showEditModal"
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<label v-if="!loadingItemTypes"
							       class="display-block margin-bottom-15">
								Pair with:
								<el-select :disabled="!$root.permissions['tax tax_classes update']"
							...
							<label>
								Apply:
								<el-select v-model="taxClassToEdit.apply"
								           placeholder="Select an option"
								           size="small">
									<el-option label="flat"
									           value="flat"
			...
			<div slot="modal-footer"
				...
				<button v-if="!$root.permissions['tax tax_classes update']"
				        @click="closeEditModal()"
				        type="button"
				        class="btn blue">
					Close
