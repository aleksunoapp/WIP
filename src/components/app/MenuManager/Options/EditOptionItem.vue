	...
	<modal :show="showEditOptionItemModal" effect="fade" @closeOnEscape="closeModal">
		...
		<div slot="modal-body" class="modal-body">
			<div class="page-one" v-if="!selectImageMode" :class="{'active': !selectImageMode, 'disabled': selectImageMode}">
				...
				<div class="col-md-3">
					<label>Option Item Image</label>
					<div class="image-container clickable" v-if="!optionItemToBeEdited.image_url">
					...
					<div class="image-container clickable" v-else>
						<img width="100" height="80" :src="optionItemToBeEdited.image_url" @click="goToPageTwo()">
					</div>
				</div>
				<div class="col-md-9">
