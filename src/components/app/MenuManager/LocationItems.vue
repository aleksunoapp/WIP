        ...
        <div v-else>
		    <div class="portlet light portlet-fit bordered margin-top-20">
		        ...
		        <div class="portlet-body relative-block">
                    ...
                    <no-results 
                        :show="!loadingItems && !items.length">
                    </no-results>

		            <div class="mt-element-list margin-top-15" v-if="items.length">
...
export default {
	...
	methods: {
		...
		getAllItemsOfLocation () {
			...
			return ItemsFunctions.getAllItemsOfLocation(this.$root.activeLocation.id).then(response => {
