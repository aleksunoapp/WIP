                            ...
                            <div class="tab-pane active page-quick-sidebar-chat">
                                <div class="page-quick-sidebar-chat-users active-business" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                                    <ul class="media-list list-items">
                                        <router-link tag="li" to="/app/profile" class="media selected-location current-location padding-sidebar-user">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active page-quick-sidebar-chat">
                                <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                                    <h3 v-if="activeLocation.id !== undefined" class="list-heading location-panel-heading blue font-default">
                                        Active Store
                                    </h3>
                                    ...
                                    <div class="padding-box padding-sidebar-search">
                                        <div class="form-group form-md-line-input form-md-floating-label">
                                            <input type="text" class="form-control input-sm padding-right-20" id="location_search" v-model="searchQuery" :class="{'edited': searchQuery.length}">
                                            <i v-if="searchQuery.length" class="fa fa-times clear-icon" @click="clearSearch()">
                                            </i>
                                    ...
                                    <div class="margin-top-30">
                                        ...
                                        <div class="tab-content">
                                            <div :class="{'tab-pane active page-quick-sidebar-chat scrollable' : activeLocation.id !== undefined, 'tab-pane active page-quick-sidebar-chat scrollable-select-location' : activeLocation.id == undefined}">
                                                <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                                                    <ul class="media-list list-items">
                                                        <li class="media padding-sidebar-store" v-for="location in searchResult" @click="selectLocation(location)" :key="location.id">
                                                            <div class="media-body">
                                                    ...
                                                    <div class="pagination-wrapper" v-show="lastPage > 1">
                                                        <div @click="goToPreviousPage()" class="pagination-arrow" :class="{ 'disabled' : currentPage === 1 }">
                                                            <i class="fa fa-angle-left" aria-hidden="true"></i>
                                                        </div>
                                                        <div @click="goToNextPage()" class="pagination-arrow" :class="{ 'disabled' : currentPage === lastPage }">
    	...
    	computed: {
    		...
    		searchResult () {
    			...
    			const searchResult = searchArray.filter(store => {
    				let searchArea =
                        store.display_name + store.address_line_1 + store.internal_id
    				return (
                        searchArea.toLowerCase().indexOf(this.searchQuery.toLowerCase()) > -1
    				)
    			})
    	...
    	if (response.code === 200 && response.status === 'ok') {
    		...
    		for (var i = 0; i < appVue.$root.storeLocations.length; i++) {
    			if (appVue.$root.storeLocations[i].is_corporate === 1) {
    				appVue.$root.corporateStoreId =
                                        appVue.$root.storeLocations[i].id
    			}
    		}
