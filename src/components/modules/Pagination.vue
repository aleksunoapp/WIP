<template>
  ...
  >
    ...
    <a>
      <li
        v-if="activePage !== 1 && activePage !== 2 && activePage !== 3"
    ...
    <a>
      <li
        v-if="activePage !== pagesArray.length && activePage !== pagesArray.length - 1 && activePage !== pagesArray.length - 2"
        class="page-number elipsis"
      >
        ...
      </li>
    ...
    <a
      @click="setActivePage(pagesArray.length)"
    >
      <li
        v-if="numPages !== 1"
        class="page-number"
