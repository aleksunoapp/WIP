  ...
  >
    ...
    >
      ...
      <h4 class="modal-title center">
        Apply {{ headerText }} To Multiple Modifier Items
      </h4>
    </div>
    <div
      slot="modal-body"
    ...
    >
      ...
      >
        <div class="portlet-title">
          <div class="caption">
            <i class="fa fa-cog font-default" />
            <span class="caption-subject font-default sbold uppercase">
              {{ selectedObject.name }}
            </span>
          </div>
        </div>
