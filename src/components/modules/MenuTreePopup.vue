<template>
    <div class="row">
        <div class="col-md-4" v-show="!showApplyToLocationsModal">
            <h4>Menus</h4>
        ...
        <div class="col-md-4" v-if="isMenuSelected" v-show="!showApplyToLocationsModal">
        ...
        <div class="col-md-4" v-if="isCategorySelected" v-show="!showApplyToLocationsModal">
