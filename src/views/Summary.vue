    ...
    <main class="contents">
      ...
      >
        ...
        <template v-if="$route.name === 'summary'">
          <div class="row bold">
            <div class="previous">
              ...
              <button
                v-if="firstApprovedServices.length"
                class="toggle"
                @click="toggleFirstApproved()"
              >
                <img
                  class="chevron"
                  :class="{'open' : firstApprovedExpanded}"
                  src="@/assets/images/chevron-down.svg"
                  aria-hidden="true"
                >
              </button>
          ...
          <transition-height>
            <div
              v-if="firstApprovedExpanded"
              class="list"
            >
              <div
                v-for="service in firstApprovedServices"
                :key="service.id"
                class="row"
              >
                <p class="item">
        ...
        <template v-if="$route.name === 'additional-summary'">
          ...
          <template v-if="previouslyApproved.count">
            <div
              class="row"
            >
              <div class="previous">
                <p class="item">
                  {{ $t("previously_approved_recommendations") }}
                  <span
                    class="bold"
                  >
          ...
          >
            <div class="previous">
              <p class="item">
                {{ $t("newly_approved_recommendations") }}
                <span
                  class="bold"
                >
                  ({{ newlyApproved.count }})
              ...
              <button
                v-if="newlyApproved.count"
                class="toggle"
                @click="toggleNewlyApproved()"
              >
                <img
                  class="chevron"
                  :class="{'open' : newlyApprovedExpanded}"
                  src="@/assets/images/chevron-down.svg"
                  aria-hidden="true"
                >
              </button>
          ...
          <transition-height>
            <div
              v-if="newlyApprovedExpanded"
              class="list"
            >
              <div
                v-for="service in newlyApproved.services"
                :key="service.id"
                class="row"
              >
                <p class="item">
...
export default Vue.extend({
  ...
  data: () => ({
    ...
    newlyApprovedExpanded: false,
    firstApprovedExpanded: false
  }),
  computed: {
    accepted: {
      get () {
  ...
  methods: {
    ...
    toggleNewlyApproved () {
      this.newlyApprovedExpanded = !this.newlyApprovedExpanded
    },
    toggleFirstApproved () {
      this.firstApprovedExpanded = !this.firstApprovedExpanded
    },
    clear () {
    ...
    sign () {
      ...
      context.fillStyle = getComputedStyle(canvas).getPropertyValue('--black')
